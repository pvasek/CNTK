...
# data set config
__C.DATA.DATASET = "Balls"
__C.DATA.MAP_FILE_PATH = "/workspace/data/balls_new_cntk"
...
__C.DATA.NUM_TRAIN_IMAGES = 250
__C.DATA.NUM_TEST_IMAGES = 50
__C.DATA.PROPOSAL_LAYER_SCALES = [4, 16, 32]
